...
object ListAdapters {
    class ContactSelectionListAdapter(listener: ClickListener<UserContactDTO>) : AppListAdapter<UserContactDTO, ItemContactSelectionBinding>(
    ...
    class ContactSelectorListAdapter(onCheckedChange: (UserContactDTO, Boolean) -> Unit) : AppListAdapter<UserContactSelectionDTO, ItemContactSelectorBinding>(
        bindData = { property, binding ->
            binding.property = property
