...
class GroupPostsFragment : AppFragment() {
    ...
    override fun onCreateView(
        ...
        arguments?.getString(getString(R.string.group_remote_id))?.let { viewModel.updateGroupRemoteId(it) }
        return binding.root
    }
    ...
    private fun getPostAdapter(isGroupAdmin: Boolean): PostsAdapter {
        ...
        return PostsAdapter(
            ...
            upVoteClickListener = ClickListener { viewModel.votePost(getVoteInput(it, VoteState.UP_VOTED)) },
            downVoteClickListener = ClickListener { viewModel.votePost(getVoteInput(it, VoteState.DOWN_VOTED)) },
